...
import { ShieldCheck, Wrench, CheckCircle2, ArrowRight, Sparkles, Clock, HardHat } from 'lucide-react';
  ...
  return (
    <main className="min-h-screen bg-slate-50 flex flex-col">
      ...
      <section className="pt-32 pb-24 bg-slate-950 relative overflow-hidden flex-shrink-0">
        {/* High-quality corporate building background */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <motion.div initial="hidden" animate="visible" variants={fadeUp}>
            <span className="inline-flex items-center px-3 py-1 rounded-full bg-cyan-500/20 text-cyan-400 border border-cyan-500/30 font-bold tracking-widest uppercase text-xs mb-6 backdrop-blur-sm">
              <Sparkles size={14} className="mr-2" /> Operational Excellence
            </span>
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-extrabold text-white mb-6 tracking-tight">
              Facility <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-400">Management</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed mb-10">
              Comprehensive maintenance, premium housekeeping, and unwavering security support to keep your corporate premises running flawlessly.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="#services" className="px-8 py-4 bg-cyan-600 text-white rounded-xl font-bold hover:bg-cyan-500 transition-colors shadow-lg shadow-cyan-600/30">
                Explore Services
              </Link>
            </div>
          </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeUp} className="relative h-[500px] lg:h-[600px]">
            ...
            <div className="absolute top-10 right-0 bg-white p-4 rounded-2xl shadow-xl flex items-center gap-4 z-30 animate-bounce-slow">
              ...
              <div>
                <p className="text-indigo-950 font-bold text-lg leading-tight">24/7</p>
                <p className="text-slate-500 text-xs font-semibold uppercase">Active Support</p>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
            <h2 className="text-cyan-600 font-bold uppercase tracking-wider text-sm mb-2">The Standard of Excellence</h2>
            <h3 className="text-3xl lg:text-4xl font-extrabold text-indigo-950 mb-6">Your Workspace, Perfected.</h3>
            <p className="text-slate-600 mb-8 leading-relaxed text-lg">
              A meticulously managed facility directly impacts employee productivity, safety, and your brand's perception. We provide end-to-end solutions customized to your building's unique requirements, ensuring complete compliance and hygiene.
            </p>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-slate-100 mb-8">
              <ul className="space-y-5">
                {[
                  ...
                  "Pest Control & Specialized Sanitization", 
      ...
      <section id="services" className="py-20 bg-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-indigo-950 mb-4">Core Management Pillars</h2>
          ...
          >
            ...
            <motion.div variants={fadeUp} whileHover={{ y: -10 }} className="bg-white p-8 rounded-3xl shadow-lg border border-slate-100 transition-all">
              ...
              <h3 className="text-xl font-bold text-indigo-950 mb-4">Security Services</h3>
              <p className="text-slate-600 leading-relaxed">
                24/7 manned guarding, access control management, and electronic surveillance monitoring to ensure total asset protection.
              </p>
            </motion.div>
            ...
            <motion.div variants={fadeUp} whileHover={{ y: -10 }} className="bg-white p-8 rounded-3xl shadow-lg border border-slate-100 transition-all">
              ...
              <h3 className="text-xl font-bold text-indigo-950 mb-4">Soft Services</h3>
              <p className="text-slate-600 leading-relaxed">
                Premium housekeeping, pantry management, and waste disposal services that maintain a pristine corporate environment.
              </p>
            </motion.div>
            ...
            <motion.div variants={fadeUp} whileHover={{ y: -10 }} className="bg-white p-8 rounded-3xl shadow-lg border border-slate-100 transition-all">
              ...
              <h3 className="text-xl font-bold text-indigo-950 mb-4">Hard Services</h3>
              <p className="text-slate-600 leading-relaxed">
                Preventative and reactive mechanical, electrical, and plumbing (MEP) maintenance to prevent costly downtime.
              </p>
            </motion.div>
          </motion.div>
        </div>
      ...
      <section className="py-20 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-br from-indigo-950 to-indigo-900 rounded-[2.5rem] p-10 md:p-16 text-center relative overflow-hidden shadow-2xl">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-black mb-6 relative z-10">Ready to secure your facility operations?</h2>
          <p className="text-cyan-100 mb-10 max-w-2xl mx-auto relative z-10 text-lg">
            Let our experts conduct a comprehensive site survey and build a tailored facility management plan for your business.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center relative z-10">
            <Link href="/contact" className="inline-flex items-center justify-center px-8 py-4 bg-cyan-600 text-white rounded-xl font-bold hover:bg-cyan-500 transition-colors shadow-lg group">
              Request A Site Survey <ArrowRight className="ml-2 group-hover:translate-x-1 transition-transform" size={20} />
            </Link>
