...
import { Plane, Globe, FileText, CheckCircle2, ArrowRight, Sparkles, ShieldCheck, MapPin } from 'lucide-react';
...
export default function OverseasPlacementsPage() {
  return (
    <main className="min-h-screen bg-slate-50 flex flex-col">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <motion.div initial="hidden" animate="visible" variants={fadeUp}>
            <span className="inline-flex items-center px-3 py-1 rounded-full bg-cyan-500/20 text-cyan-400 border border-cyan-500/30 font-bold tracking-widest uppercase text-xs mb-6 backdrop-blur-sm">
              <Sparkles size={14} className="mr-2" /> Global Opportunities
            </span>
            <h1 className="text-4xl md:text-5xl lg:text-7xl font-extrabold text-white mb-6 tracking-tight">
              Overseas <span className="text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-400">Placements</span>
            </h1>
            <p className="text-lg md:text-xl text-slate-300 max-w-3xl mx-auto leading-relaxed mb-10">
              Take your career to the international stage. We handle the complexities of global hiring, visas, and seamless onboarding for a stress-free transition.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link href="#explore" className="px-8 py-4 bg-cyan-600 text-white rounded-xl font-bold hover:bg-cyan-500 transition-colors shadow-lg shadow-cyan-600/30">
                Start Your Journey
              </Link>
            </div>
          </motion.div>
      ...
      <section id="explore" className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex-grow">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} variants={fadeUp} className="relative h-[500px] lg:h-[600px]">
            ...
            <div className="absolute top-10 right-0 bg-white p-4 rounded-2xl shadow-xl flex items-center gap-4 z-30 animate-bounce-slow">
              ...
              <div>
                <p className="text-indigo-950 font-bold text-lg leading-tight">100% Secure</p>
                <p className="text-slate-500 text-xs font-semibold uppercase">Verified Employers</p>
              </div>
            </div>
          </motion.div>
          ...
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
            <h2 className="text-cyan-600 font-bold uppercase tracking-wider text-sm mb-2">Work Beyond Borders</h2>
            <h3 className="text-3xl lg:text-4xl font-extrabold text-indigo-950 mb-6">A Seamless Global Transition.</h3>
            <p className="text-slate-600 mb-8 leading-relaxed text-lg">
              Relocating for work can be daunting. We specialize in connecting talent with prestigious companies in the Middle East, Europe, and Asia. Our dedicated team ensures a fully compliant, transparent, and supportive placement process from start to finish.
            </p>
            ...
            <div className="bg-white p-8 rounded-2xl shadow-lg border border-slate-100 mb-8">
              <ul className="space-y-5">
                {[
                  ...
                  "Direct Client Interviews & Secure Offers", 
                  "Pre-Departure Orientation & Cultural Briefing", 
                  "Flight Ticketing & Accommodation Guidance"
                ].map((item, i) => (
      ...
      <section className="py-20 bg-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl font-bold text-indigo-950 mb-4">How We Support Your Relocation</h2>
          ...
          >
            ...
            <motion.div variants={fadeUp} whileHover={{ y: -10 }} className="bg-white p-8 rounded-3xl shadow-lg border border-slate-100 transition-all">
              ...
              <h3 className="text-xl font-bold text-indigo-950 mb-4">Global Network</h3>
              <p className="text-slate-600 leading-relaxed">
                We hold trusted, verified partnerships with multinational corporations, giving you access to legitimate, high-paying international roles.
              </p>
            </motion.div>
            ...
            <motion.div variants={fadeUp} whileHover={{ y: -10 }} className="bg-white p-8 rounded-3xl shadow-lg border border-slate-100 transition-all">
              ...
              <h3 className="text-xl font-bold text-indigo-950 mb-4">Documentation</h3>
              <p className="text-slate-600 leading-relaxed">
                We cut through the red tape. Our team handles the complexities of contract attestation, work permits, and immigration compliance.
              </p>
            </motion.div>
            ...
            <motion.div variants={fadeUp} whileHover={{ y: -10 }} className="bg-white p-8 rounded-3xl shadow-lg border border-slate-100 transition-all">
              ...
              <h3 className="text-xl font-bold text-indigo-950 mb-4">Relocation Support</h3>
              <p className="text-slate-600 leading-relaxed">
                Beyond the job offer, we provide crucial guidance on travel arrangements, initial accommodation setup, and settling into a new country.
              </p>
            </motion.div>
          </motion.div>
        </div>
      ...
      <section className="py-20 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-br from-indigo-950 to-indigo-900 rounded-[2.5rem] p-10 md:p-16 text-center relative overflow-hidden shadow-2xl">
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6 relative z-10">Ready to take your career global?</h2>
          <p className="text-cyan-100 mb-10 max-w-2xl mx-auto relative z-10 text-lg">
            Join thousands of professionals who have successfully built rewarding careers abroad with our expert guidance.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center relative z-10">
            <Link href="/contact" className="inline-flex items-center justify-center px-8 py-4 bg-cyan-600 text-white rounded-xl font-bold hover:bg-cyan-500 transition-colors shadow-lg group">
              Apply For Global Roles <ArrowRight className="ml-2 group-hover:translate-x-1 transition-transform" size={20} />
            </Link>
